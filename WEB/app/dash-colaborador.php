		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
						<label class="col-sm-3 control-label">Data Consulta</label>
						<div class="col-sm-6">
							<input type="text" name="txtdata" class="form-control" required="required">
						</div>
					</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
                     ...
                     <div class="form-group">
						...
						<div class="col-sm-6">
							<textarea name="acao" class="form-control" required></textarea>
						</div>
					</div>
                     ...
                     <div class="form-group">
						...
						<div class="col-sm-6">
							<textarea name="fundamento" class="form-control" required></textarea>
						</div>
					</div>
