                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="threads">
                                    <ul class="panel-threads">
                                        <li>
                                            <img src="js/assets/demo/avatar/aniss.png" alt="Aniss">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/corbett.png" alt="Corbett">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/dangerfield.png" alt="Dangerfield">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/doyle.png" alt="Doyle">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/jackson.png" alt="Jackson">
                                            <div class="content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <ul class="panel-comments">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/paton.png" alt="Corbett">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/watson.png" alt="Watson">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                ...
                                <div class="tab-pane" id="users">
                                    <ul class="panel-users">
                                        <li>
                                            <img src="js/assets/demo/avatar/paton.png" alt="Paton">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/tennant.png" alt="Tennant">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="js/assets/demo/avatar/jobs.png" alt="Jobs">
                                            <div class="content">
