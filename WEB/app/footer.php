...
<script type='text/javascript' src='<?php echo asset("assets/js/enquire.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/js/jquery.cookie.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/js/jquery.nicescroll.min.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/codeprettifier/prettify.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/easypiechart/jquery.easypiechart.min.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/sparklines/jquery.sparklines.min.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/form-toggle/toggle.min.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/form-validation/jquery.validate.min.js") ?>'></script> 
<script type='text/javascript' src='<?php echo asset("assets/plugins/form-stepy/jquery.stepy.js") ?>'></script> 
